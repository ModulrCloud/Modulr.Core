...
_NOT_FOUND = frozenset({
    ...
    ErrorCode.GENESIS_CHALLENGE_NOT_FOUND,
})
_CONFLICT = frozenset({
    ...
    ErrorCode.GENESIS_ALREADY_COMPLETE,
    ErrorCode.GENESIS_CHALLENGE_CONSUMED,
    ErrorCode.GENESIS_CHALLENGE_EXPIRED,
...
_FORBIDDEN = frozenset({
    ...
    ErrorCode.GENESIS_OPERATIONS_NOT_ALLOWED,
})
